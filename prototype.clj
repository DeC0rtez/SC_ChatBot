...
[keyword]
  (cond
    ...
    (contains? synonyms_toilet keyword) (def category :toilet)
    (contains? synonyms_POI keyword) (def category :POI)
    (contains? synonyms_bike keyword) (def category :bike_path)
    (contains? synonyms_skating keyword) (def category :skating)
    (contains? synonyms_sports keyword) (def category :sports_field)
    (contains? synonyms_playground keyword) (def category :playground)
    (contains? synonyms_public_transport keyword) (def category :public_transport)
    (contains? synonyms_coords keyword) (def category :GPS_coords)
    (contains? synonyms_parking keyword) (def category :parking)
    (contains? synonyms_dogs keyword) (def category :dogs)
    (contains? synonyms_path keyword) (def category :path_type)
    (contains? synonyms_administration keyword) (def category :administered_by)
    (contains? synonyms_hours keyword) (def category :opening_hours)
    (contains? synonyms_map keyword) (def category :map_url)
...
; [park bool]
; (cond
;         (= (park :dogs) nil) (println "I know :dogs is nil")
;         :else (println "I do not know :dogs is nil")))