...
(def Obora_Hvezda{
    ...
    :POIs "Suitable for tourists and families with children, heritage trees, nature trail, natural attractions"
    ;---Children and Sport---
    :bike_path true
    :skating false
    :sports_field false
...
(def Letna{
    ...
    :POIs "Spacious area for free time activities, suitable for all age categories, year-long: cultural events, suited for a day-long stay"
    ;---Children and Sport---
    :bike_path true
    :skating true
    :sports_field false
...
;how to get data:
;(println(parkname :data_cat))
;EXAMPLE:
;(println(Vysehrad :POIs))