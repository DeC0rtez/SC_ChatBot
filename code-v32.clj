...
(def alt_food #{"eat","dinner","lunch","breakfast","food","dine","hungry","hunger","snack","meal","drink","restaraunt","cafe","bar"})
(def alt_toilet #{"wc","restroom","bathroom","toilet","outhouse","lavatory"})
...
(def alt_sports #{"sport","exercise","work out","workout","working out","gym","athletic","soccer","tennis","ball"})
(def alt_playground #{"playground","playpen","sandbox","child","kid"})
(def alt_public_transport #{"bus","metro","subway","tube","underground","tram","mhd","public transport","get there","get here","travel"})
(def alt_coords #{"coodrinates","co-ordinates","coords","co-ords","gps"})
(def alt_parking #{"car","automobile","parking","to park"})
(def alt_dogs #{"dog","pet"})
